...
#this is the basic html for about us page
@app.route('/about')
def about():
    return render_template('about.html')

#this is the flask template that render link data from run
#change href=/about2 in both home.html and base.html to run it
@app.route('/about2')
def about2():
    data = {
        'related': [
            {'name': 'Drexel Bike Share', 'url': 'https://drexel.edu/campusservices/studentCenters/creeseCenter/BikeShare/'},
        ]
    }
    return render_template('about2.html', data=data)

# route to Our Bikes section
# new function and variable to store the bike data
# lastly the call to render_template() in bikes.html
@app.route('/bikes')
def bikes():
    data = {
        'types': [
